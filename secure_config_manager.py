...
Handles sensitive configuration data (like broker passwords) in encrypted SQLite database.
"""
...
# Get logger for secure config
secure_logger = get_logger("secure_config")
...
class SecureConfigManager:
    ...
    def _get_or_create_key(self) -> bytes:
        ...
        if key_file.exists():
            ...
            secure_logger.info("Generated new encryption key")
            return key
    ...
    def init_database(self):
        ...
        with sqlite3.connect(self.db_path) as conn:
            ...
            conn.commit()
            secure_logger.info("Secure configuration database initialized")
    ...
    def save_broker_config(self, broker_config: Dict[str, Any]) -> bool:
        ...
        try:
            ...
            with sqlite3.connect(self.db_path) as conn:
                ...
                conn.commit()
                secure_logger.info("Broker configuration saved securely")
                return True
                
        except Exception as e:
            secure_logger.error(f"Failed to save broker config: {e}")
            return False
